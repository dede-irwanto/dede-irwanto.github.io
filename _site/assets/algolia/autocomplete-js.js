...
!(function (e, t) {
  ...
  var y = function () {},
    b = "1.7.1",
    O = [{ segment: "autocomplete-core", version: b }];
  function _(e, t) {
    var n = t;
    return {
      then: function (t, r) {
  ...
  function P(e) {
    return _(e, { isCanceled: !1, onCancelList: [] });
  }
  function j(e, t, n) {
    return e
      ? function (n) {
  ...
  function fe(e) {
    ...
    var y = P(
      pe(
        o
          .getSources(oe({ query: i, refresh: u, state: a.getState() }, c))
          .then(function (e) {
            return Promise.all(
              e.map(function (e) {
                return Promise.resolve(
                  e.getItems(
                    oe({ query: i, refresh: u, state: a.getState() }, c)
                  )
                ).then(function (t) {
          ...
          we(
            {
              ...
              onSubmit: function (i) {
                ...
                i.preventDefault(),
                  t.onSubmit(
                    we({ event: i, refresh: n, state: r.getState() }, o)
                  ),
        ...
        return we(
          {
            ...
            onKeyDown: function (e) {
              ...
              })(we({ event: e, props: t, refresh: n, store: r }, o));
            },
            onFocus: u,
            onBlur: y,
            onClick: function (n) {
  ...
  function ke(e) {
    ...
    return {
      ...
      options: Ce({ "autocomplete-core": Object.keys(u) }, c),
      ua: O.concat(
  ...
  var Te = function (e, t) {
    switch (t.type) {
      ...
      case "mousemove":
        return qe(qe({}, e), {}, { activeItemId: t.payload });
      case "setQuery":
        return qe(qe({}, e), {}, { query: t.payload, completion: null });
      case "setCollections":
        return qe(qe({}, e), {}, { collections: t.payload });
      case "setIsOpen":
        return qe(qe({}, e), {}, { isOpen: t.payload });
      case "setStatus":
        return qe(qe({}, e), {}, { status: t.payload });
      case "setContext":
        return qe(qe({}, e), {}, { context: qe(qe({}, e.context), t.payload) });
      case "ArrowDown":
        var n = qe(
          qe({}, e),
          {},
        ...
        return qe(qe({}, n), {}, { completion: xe({ state: n }) });
      case "ArrowUp":
        var r = qe(
          qe({}, e),
          {},
        ...
        return qe(qe({}, r), {}, { completion: xe({ state: r }) });
      case "Escape":
        return e.isOpen
          ? qe(
              qe({}, e),
      ...
      case "blur":
        return t.props.debug
          ? e
          : qe(qe({}, e), {}, { isOpen: !1, activeItemId: null });
      case "mouseleave":
        return qe(qe({}, e), {}, { activeItemId: t.props.defaultActiveItemId });
      default:
        return (
  ...
  function Me(e) {
    var t = [],
      ...
      r = R(Te, n, function (e) {
        var t = e.prevState,
          r = e.state;
        n.onStateChange(Be({ prevState: t, state: r, refresh: u }, o));
      }),
      o = (function (e) {
        var t = e.store;
        return {
                ...
                return L(
                  ...
                  {},
                  {
                    items: d(e.items).map(function (e) {
                      return L(L({}, e), {}, { __autocomplete_id: n++ });
                    }),
                  }
                );
              });
      ...
      i = Ee(Be({ props: n, refresh: u, store: r }, o));
    function u() {
      return fe(
        Be(
          {
    ...
    return (
      ...
      (function (e) {
        ...
        metadata: ke({ plugins: n.plugins, options: e }),
  ...
  function ct(e) {
    var t = e.autocomplete,
      ...
      d = e.translations,
      m = ot(i),
      v = s.getRootProps(n({ state: f, props: t.getRootProps({}) }, r)),
      h = m("div", n({ class: o.root }, v)),
      g = m("div", {
      ...
      O = m("button", {
        ...
        children: [at({ environment: i })],
      }),
      _ = m("label", n({ class: o.label, children: [O] }, b)),
      P = m("button", {
        class: o.clearButton,
        type: "reset",
        title: d.clearButtonTitle,
        children: [We({ environment: i })],
      }),
      j = m("div", {
        class: o.loadingIndicator,
        children: [ut({ environment: i })],
      }),
      w = (function (e) {
      ...
      S = m("div", { class: o.inputWrapperPrefix, children: [_, j] }),
      I = m("div", { class: o.inputWrapperSuffix, children: [P] }),
      E = m("div", { class: o.inputWrapper, children: [w] }),
      A = s.getFormProps(
        n({ state: f, props: t.getFormProps({ inputElement: w }) }, r)
      ),
      C = m("form", n({ class: o.form, children: [S, E, I] }, A)),
      D = s.getPanelProps(n({ state: f, props: t.getPanelProps({}) }, r)),
      k = m("div", n({ class: o.panel }, D));
    if (a) {
      var x = m("div", {
        ...
        T = m("div", { class: o.detachedFormContainer, children: [C, R] });
      ...
      if (
        ...
        (d = n.__k[s] =
          null == (d = t[s]) || "boolean" == typeof d
            ...
            : Array.isArray(d)
            ? _t(Pt, { children: d }, null, null, null)
            : d.__b > 0
  ...
  function $t(e) {
    ...
    return (
      "string" != typeof o && (o = h(t, r) || ""), Vt({ highlightedValue: o })
    );
  }
  var zt = {
      "&amp;": "&",
  ...
  function tn(e) {
    return e.some(function (e) {
      ...
      ? e.map(function (t, n) {
          return Zt(Zt({}, t), {}, { isHighlighted: !Yt(e, n) });
        })
      : e.map(function (e) {
          return Zt(Zt({}, e), {}, { isHighlighted: !1 });
        });
  }
  function nn(e) {
    return (
  ...
  function hn(e) {
    ...
    function r(e) {
      ...
      return t(
        n,
        {},
        $t({ hit: r, attribute: o }).map(function (e, n) {
  ...
  function gn(e) {
    ...
    function r(e) {
      ...
      return t(
        n,
        {},
        ((r = { hit: o, attribute: i }), tn($t(r))).map(function (e, n) {
  ...
  function yn(e) {
    ...
    function r(e) {
      ...
      return t(
        n,
        {},
        ((r = { hit: o, attribute: i }), tn(on(r))).map(function (e, n) {
          return e.isHighlighted ? t(a, { key: n }, e.value) : e.value;
        })
      );
    }
  ...
  function bn(e) {
    ...
    function r(e) {
      ...
      return t(
        n,
        {},
        on({ hit: r, attribute: o }).map(function (e, n) {
          return e.isHighlighted ? t(u, { key: n }, e.value) : e.value;
        })
      );
    }
  ...
  var Sn = [{ segment: "autocomplete-js", version: b }],
    In = ["components"];
  var En = (function (e, t) {
    function n(t) {
      return e({
    ...
    return function (e) {
      return function (r) {
        return an(an({ requesterId: t, execute: n }, e), r);
      };
    };
  })(function (e) {
    return (function (e) {
    ...
    function C(e) {
      ...
      !(function (e) {
        ...
        nt(
          ...
          tt(o.label, { hidden: "stalled" === u.status }),
          tt(o.loadingIndicator, { hidden: "stalled" !== u.status }),
          tt(o.clearButton, { hidden: !u.query });
      })(t),
        (function (e, t) {
          ...
          if (p.isOpen) {
            ...
            var m = p.collections
                    ...
                    c.templates.noResults && 0 === l.length
                      ...
                      : d.createElement(
                          ...
                          i(
                            { className: u.list },
                            s.getListProps(
                              n({ state: p, props: r.getListProps({}) }, o)
                            )
                          ),
                          l.map(function (e) {
                            ...
                            return d.createElement(
                              ...
                              i(
                                ...
                                s.getItemProps(n({ state: p, props: t }, o))
                              ),
                              c.templates.item({
                                components: f,
                                createElement: d.createElement,
              ...
              v = d.createElement(
                d.Fragment,
                null,
                d.createElement("div", { className: u.panelLayout }, m),
            ...
            e(
              n(
                n({ children: v, state: p, sections: m, elements: h }, d),
                {},
                { components: f, html: a },
                o
              ),
